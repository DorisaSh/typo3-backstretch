<?php
namespace W3D\T3tBackstretch\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class W3D\T3tBackstretch\Controller\ImageController.
 *
...
class ImageControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \W3D\T3tBackstretch\Controller\ImageController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('W3D\\T3tBackstretch\\Controller\\ImageController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllImagesFromRepositoryAndAssignsThemToView() {
		...
		$imageRepository = $this->getMock('W3D\\T3tBackstretch\\Domain\\Repository\\ImageRepository', array('findAll'), array(), '', FALSE);
